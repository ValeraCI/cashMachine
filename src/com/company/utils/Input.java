...
public class Input {
    ...
    public static CardType inputCardType(){
        while (true){
            System.out.print("""
                    Выберите тип карты:
                    1. Золотая(нулевой комиссия при пополнении и снятии средств)
                    2. Серебренная(при пополнении и снятии накладывается комиссия в три процента)
                    3. Бронзовая(при пополнении и снятии накладывается комиссия в пять процентов)
